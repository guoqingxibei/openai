...
const (
	...
	CensorWarning     = "【温馨提醒】很抱歉识别出了可能不宜展示的内容。如有误判，可回复contact联系作者，作者将继续进行优化调整。为了公众号能持续向大家提供服务，请大家不要在这里讨论色情、政治、暴恐、VPN等相关内容，谢谢配合❤️"
	...
	ZeroChatBalance   = "很抱歉，今天的对话次数（每天40次）用完了，明天再来吧。费用昂贵，敬请谅解❤️如果使用量确实很大，可回复contact联系作者。"
