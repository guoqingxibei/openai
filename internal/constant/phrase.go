...
const (
	...
	TryAgain          = "哎呀，出错啦（多是请求量过大导致的ChatGPT负载过高），请重试~\n\n如果问题持续存在，可直接反馈给作者（微信：programmer_guy）。"
	ExpireError       = "哎呀，消息过期了，重新提问吧~"
	CensorWarning     = "【温馨提醒】很抱歉识别出了可能不宜讨论的内容。如有误判，可直接反馈给作者（微信：programmer_guy），作者将继续进行优化调整。\n\n为了公众号能持续向大家提供服务，请大家不要在这里讨论色情、政治、暴恐、VPN等相关内容，谢谢配合❤️"
