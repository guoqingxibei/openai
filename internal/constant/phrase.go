...
const (
	...
	ZeroChatBalance        = "很抱歉，今天的对话次数（每天10次）用完了，明天再来吧。费用昂贵（一次长对话约0.1元），敬请谅解❤️\n\n如果使用量很大，可长按或扫描下方二维码联系作者进行购买（20元400次，50元1100次，100元2500次），你的支持对作者而言非常重要！\n\n![](./images/writer_qr.jpg)"
