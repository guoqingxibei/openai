...
const (
	...
	TryAgain          = "哎呀，出错啦，请重试~"
	CensorWarning     = "【温馨提醒】很抱歉识别出了可能不宜展示的内容。如果误判，可以回复contact联系作者，作者将继续进行优化调整。为了公众号能持续向大家提供免费的优质服务，拜托大家不要在这里讨论色情、政治、暴恐、VPN等相关内容，谢谢配合❤️"
	ChatUsage         = "你问ChatGPT答，每天%d次，剩余%d次。"
	...
	SubscribeReply    = "此公众号已接入ChatGPT 3.5，直接向我提问吧~\n\n回复contact，可联系作者。\n回复donate，可捐赠作者。"
	ZeroImageBalance  = "很抱歉，今天的画图次数（每天1次）用完了，明天再来吧。费用昂贵，敬请谅解❤️\n\n回复chat，可切换到聊天模式。"
	ZeroChatBalance   = "很抱歉，今天的对话次数（每天50次）用完了，明天再来吧。费用昂贵，敬请谅解❤️"
