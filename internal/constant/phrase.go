...
const (
	...
	TryAgain          = "哎呀，出错啦，请重试。"
	CensorWarning     = "【审核】识别出可能不宜展示的内容。如有误判，请谅解，作者将继续进行优化。为了公众号能持续向大家提供服务，请避免在这里讨论色情、政治、暴恐等相关的内容，谢谢配合。"
	ChatUsage         = "你问ChatGPT答，每天%d次，剩余%d次。【另】由于用户激增，费用也随之大幅上涨，4月12日后关注的用户每日额度将从100调整为50，请谅解。"
	...
	ZeroBalance       = "今天的%s次数用完了，明天再来吧。回复help，获取帮助。"
)
