...
const (
	...
	ChatUsage      = "你问我答，多轮对话，不限次数。"
	ImageUsage     = "你说一句图片描述，我回一张图片，单轮对话，每天仅限 5 次（一张接近两毛，成本昂贵，敬请谅解）。"
	UsageTail      = "回复 help，可查看详细用法。\n回复 donate，可捐赠作者。"
	DonateDesc     = "回复 donate，可对作者进行捐赠。所有对话都会产生费用，你的捐赠可以减轻作者的财务压力。捐赠与否，并不影响你对服务的使用。"
